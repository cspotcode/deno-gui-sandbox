// Copied from https://deno.land/x/dwm/examples/imgui2.ts (https://github.com/deno-windowing/dwm/blob/main/examples/imgui2.ts)
import * as gl from "gluten"
import { createContext, destroyContext, imgui } from "dwm/ext/imgui.ts";
import {
    getPrimaryMonitor,
    getProcAddress,
    mainloop,
    WindowCanvas,
} from "dwm/ext/canvas.ts";
